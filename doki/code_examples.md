  ...
  = simple_form_for(@q, url: admin_users_path, method: :get, html: {class: 'search-form'}) do |f|
    ...
    .card-title.p-12.pt-24
      .row
        ...
        .col-xs-12.col-sm-6.col-md-4= f.input :email_i_cont,
                            label:         t('activerecord.attributes.user.email'),
                            required:      false

        .col-xs-12.col-sm-6.col-md-2= f.input :role_eq,
        ...
        .col-xs-12.col-sm-6.col-md-2= f.input :locale_eq,
        ...
        .col-xs-12.col-sm-6.col-md-2= f.input :deleted_eq,
        ...
        .col-xs-12.col-sm-6.col-md-2= f.input :blocked_eq,
